    ...
    <>
      ...
      <main className="m-auto h-[200%] max-w-lg px-4">
        ...
        <section className="relative">
          <svg
            className="absolute right-0 z-[-2] h-64 w-64 translate-x-1/2 -translate-y-[15%] opacity-10"
            version="1.1"
          ...
          <h2 className="relative -ml-4 w-fit bg-[#79584d] py-2 pl-4 pr-6 text-5xl font-medium text-white">
            <div className="absolute right-0 top-1/2 z-[-1] h-full w-16 -translate-y-1/2 translate-x-1/2 rounded-full bg-[#79584d]"></div>
            This is me
          </h2>
